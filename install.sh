...
configure_database() {
    ...
    sudo mysql -e "CREATE TABLE Dbvocabulary.user (ID int(11) NOT NULL, username text NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;"
    sudo mysql -e "INSERT INTO Dbvocabulary.user (ID, username) VALUES (1, 'projectadmin');"
    sudo mysql -e "CREATE TABLE Dbvocabulary.vocabulary (ID int(11) NOT NULL, language1 text NOT NULL, language2 text NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;"
