...
configure_database() {
    ...
    sudo mysql -e "CREATE TABLE Dbvocabulary.mistake (ID int(11) NOT NULL, vocabularyID int(11) NOT NULL, userid int(11) NOT NULL, mistake int(11) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;"
    sudo mysql -e "CREATE TABLE Dbvocabulary.user (ID int(11) NOT NULL, username text NOT NULL, userid int(11) NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;"
    sudo mysql -e "INSERT INTO Dbvocabulary.user (ID, username, userid) VALUES (1, 'projectadmin', 1);"
    sudo mysql -e "CREATE TABLE Dbvocabulary.vocabulary (ID int(11) NOT NULL, vocabularyID int(11) NOT NULL, language1 text NOT NULL, language2 text NOT NULL) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;"
    sudo mysql -e "ALTER TABLE Dbvocabulary.mistake ADD PRIMARY KEY (ID);"
    sudo mysql -e "ALTER TABLE Dbvocabulary.user ADD PRIMARY KEY (ID);"
    sudo mysql -e "ALTER TABLE Dbvocabulary.vocabulary ADD PRIMARY KEY (ID);"
    sudo mysql -e "ALTER TABLE Dbvocabulary.mistake MODIFY ID int(11) NOT NULL AUTO_INCREMENT;"
    sudo mysql -e "ALTER TABLE Dbvocabulary.user MODIFY ID int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=0;"
    sudo mysql -e "ALTER TABLE Dbvocabulary.vocabulary MODIFY ID int(11) NOT NULL AUTO_INCREMENT;"
